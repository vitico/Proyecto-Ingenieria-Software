...
@observer
class HeaderCell extends React.Component<HeaderCellProps, HeaderCelltate> {
    static propTypes = {
    ...
    static getDerivedStateFromProps(
        nextProps: HeaderCellProps,
        prevState: HeaderCelltate
    ) {
        if (
            ...
            return {
                ...
                columnWidth: isNullOrUndefined(nextProps.flexGrow)
                    ? nextProps.width
                    : 0,
            };
        }
    ...
    renderSortColumn(): React.ReactNode {
        ...
        if (sortable) {
            const SortIcon =
                sortColumn === dataKey ? SORTED_MAP[sortType] : Sort;
